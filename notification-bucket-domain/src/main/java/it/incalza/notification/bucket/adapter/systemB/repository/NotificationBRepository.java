...
import it.incalza.notification.bucket.domain.NotificationRepository;

/**
 * Created by sincalza on 04/12/2016.
 */
public interface NotificationBRepository extends NotificationRepository<NotificationB> {
}
